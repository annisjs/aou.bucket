#' Sync packages between Verily workspace and bucket
#' @examples 
#' \dontrun{
...
#' @export
sync_packages_verily <- function()
{
  my_bucket <- Sys.getenv("WORKSPACE_BUCKET")
  system(stringr::str_glue("gcloud storage rsync /opt/conda/envs/jupyter/lib/R/library {my_bucket}/packages --recursive"),intern=T)
  system(stringr::str_glue("gcloud storage rsync {my_bucket}/packages /opt/conda/envs/jupyter/lib/R/library --recursive"),intern=T)
}